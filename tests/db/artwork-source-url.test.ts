    ...
    try {
      ...
      const [image] = await testDb
        ...
        .values({
          ...
          sourceUrl:
            'https://assets.artworkarchive.com/image/upload/example.jpg',
          isPrimary: true,
          sortOrder: 0,
        })
        .returning()
      ...
      const [file] = await testDb
        ...
        .values({
          ...
          name: 'Certificate',
          sourceUrl:
            'https://assets.artworkarchive.com/image/upload/example.pdf',
          sortOrder: 0,
        })
        .returning()
